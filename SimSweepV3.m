...
k_scale_all = logspace(-1,3,11);%21);
% k_scale_all(1)=[];
...
%         figure(1)
        ...
        [mfi,mvi,mnb1i,mnb2i,mdint1i,mdint2i,mti,CumStruct{i,ii},nOpenedTot(ii,i)] = clutchmodeltalinBender(nm,fm1,vu,nc,dint1,dint2,kont1,kont2,kof1,kof2,kc,ksub,konv,pt,mr,intadd,ion,Data,k_scale,xCut(i),xtst,0);
...
save('Sweep slip without reinforcement.mat')
